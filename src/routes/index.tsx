  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: PATH_PAGE.profile(":id"), element: <AuthGuard><Profile /></AuthGuard>, },
        { path: PATH_PAGE.profileEdit(":id"), element: <AuthGuard><EditProfile /></AuthGuard>, },
      ]
    },
    { path: '*', element: <Navigate to="/404" replace /> },
  ]);
...
const EditProfile = Loadable(lazy(() => import('../pages/EditProfile')));
